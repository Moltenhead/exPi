...
$.Slider = function (elt) {
  ...
  */
  ...
  this.contMaxDecal = Math.round(this.container.width() / this.width);
...
$.Slider.prototype = {
  ...
  adjustPos: function ()
  {
    var newPose = this.decal * width + baseLeft;
  ...
  InitEvents: function ()
  {
    ...
    _this.nav.right.click(function ()
      {
